...
_See code: [src/commands/agent/create.ts](https://github.com/salesforcecli/plugin-agent/blob/1.2.1/src/commands/agent/create.ts)_
...
_See code: [src/commands/agent/generate/spec.ts](https://github.com/salesforcecli/plugin-agent/blob/1.2.1/src/commands/agent/generate/spec.ts)_
...
_See code: [src/commands/agent/test/cancel.ts](https://github.com/salesforcecli/plugin-agent/blob/1.2.1/src/commands/agent/test/cancel.ts)_
...
_See code: [src/commands/agent/test/run.ts](https://github.com/salesforcecli/plugin-agent/blob/1.2.1/src/commands/agent/test/run.ts)_
