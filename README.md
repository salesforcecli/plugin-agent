...
_See code: [src/commands/agent/activate.ts](https://github.com/salesforcecli/plugin-agent/blob/1.32.21/src/commands/agent/activate.ts)_
...
_See code: [src/commands/agent/create.ts](https://github.com/salesforcecli/plugin-agent/blob/1.32.21/src/commands/agent/create.ts)_
...
_See code: [src/commands/agent/deactivate.ts](https://github.com/salesforcecli/plugin-agent/blob/1.32.21/src/commands/agent/deactivate.ts)_
...
_See code: [src/commands/agent/generate/agent-spec.ts](https://github.com/salesforcecli/plugin-agent/blob/1.32.21/src/commands/agent/generate/agent-spec.ts)_
...
_See code: [src/commands/agent/generate/authoring-bundle.ts](https://github.com/salesforcecli/plugin-agent/blob/1.32.21/src/commands/agent/generate/authoring-bundle.ts)_
...
_See code: [src/commands/agent/generate/template.ts](https://github.com/salesforcecli/plugin-agent/blob/1.32.21/src/commands/agent/generate/template.ts)_
...
_See code: [src/commands/agent/generate/test-spec.ts](https://github.com/salesforcecli/plugin-agent/blob/1.32.21/src/commands/agent/generate/test-spec.ts)_
...
_See code: [src/commands/agent/preview.ts](https://github.com/salesforcecli/plugin-agent/blob/1.32.21/src/commands/agent/preview.ts)_
...
_See code: [src/commands/agent/preview/end.ts](https://github.com/salesforcecli/plugin-agent/blob/1.32.21/src/commands/agent/preview/end.ts)_
...
_See code: [src/commands/agent/preview/send.ts](https://github.com/salesforcecli/plugin-agent/blob/1.32.21/src/commands/agent/preview/send.ts)_
...
_See code: [src/commands/agent/preview/sessions.ts](https://github.com/salesforcecli/plugin-agent/blob/1.32.21/src/commands/agent/preview/sessions.ts)_
...
_See code: [src/commands/agent/preview/start.ts](https://github.com/salesforcecli/plugin-agent/blob/1.32.21/src/commands/agent/preview/start.ts)_
...
_See code: [src/commands/agent/publish/authoring-bundle.ts](https://github.com/salesforcecli/plugin-agent/blob/1.32.21/src/commands/agent/publish/authoring-bundle.ts)_
...
_See code: [src/commands/agent/test/create.ts](https://github.com/salesforcecli/plugin-agent/blob/1.32.21/src/commands/agent/test/create.ts)_
...
_See code: [src/commands/agent/test/list.ts](https://github.com/salesforcecli/plugin-agent/blob/1.32.21/src/commands/agent/test/list.ts)_
...
_See code: [src/commands/agent/test/results.ts](https://github.com/salesforcecli/plugin-agent/blob/1.32.21/src/commands/agent/test/results.ts)_
...
_See code: [src/commands/agent/test/resume.ts](https://github.com/salesforcecli/plugin-agent/blob/1.32.21/src/commands/agent/test/resume.ts)_
...
_See code: [src/commands/agent/test/run.ts](https://github.com/salesforcecli/plugin-agent/blob/1.32.21/src/commands/agent/test/run.ts)_
...
_See code: [src/commands/agent/validate/authoring-bundle.ts](https://github.com/salesforcecli/plugin-agent/blob/1.32.21/src/commands/agent/validate/authoring-bundle.ts)_
