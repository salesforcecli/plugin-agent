...
_See code: [src/commands/agent/create.ts](https://github.com/salesforcecli/plugin-agent/blob/1.20.10/src/commands/agent/create.ts)_
...
_See code: [src/commands/agent/generate/agent-spec.ts](https://github.com/salesforcecli/plugin-agent/blob/1.20.10/src/commands/agent/generate/agent-spec.ts)_
...
_See code: [src/commands/agent/generate/template.ts](https://github.com/salesforcecli/plugin-agent/blob/1.20.10/src/commands/agent/generate/template.ts)_
...
_See code: [src/commands/agent/generate/test-spec.ts](https://github.com/salesforcecli/plugin-agent/blob/1.20.10/src/commands/agent/generate/test-spec.ts)_
...
_See code: [src/commands/agent/preview.ts](https://github.com/salesforcecli/plugin-agent/blob/1.20.10/src/commands/agent/preview.ts)_
...
_See code: [src/commands/agent/test/create.ts](https://github.com/salesforcecli/plugin-agent/blob/1.20.10/src/commands/agent/test/create.ts)_
...
_See code: [src/commands/agent/test/list.ts](https://github.com/salesforcecli/plugin-agent/blob/1.20.10/src/commands/agent/test/list.ts)_
...
_See code: [src/commands/agent/test/results.ts](https://github.com/salesforcecli/plugin-agent/blob/1.20.10/src/commands/agent/test/results.ts)_
...
_See code: [src/commands/agent/test/resume.ts](https://github.com/salesforcecli/plugin-agent/blob/1.20.10/src/commands/agent/test/resume.ts)_
...
_See code: [src/commands/agent/test/run.ts](https://github.com/salesforcecli/plugin-agent/blob/1.20.10/src/commands/agent/test/run.ts)_
